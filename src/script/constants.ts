export const skillElaborations = {
  js: {
    friendlyName: "JavaScript / TypeScript",
    elaboration: `TypeScript has been my bread and butter for the last four years
  ...
  css: {
    ...
    elaboration: `I have a nerdy obsession with styling and a deep understanding of
  ...
  java: {
    friendlyName: "Java",
    elaboration: `My Java experience is limited to a time much earlier in my career
    and, more recently, only on existing packages. At Amazon, my Java work was mostly
  ...
  react: {
    friendlyName: "React",
    elaboration: `For the last four years at Amazon, I worked on an internal tools
    website using react and TypeScript. As the primary owner of this website, I created
  ...
  express: {
    ...
    elaboration: `A main part of the stack that I taught at General Assembly, Express
  ...
  graphql: {
    ...
    elaboration: `While I have spent the last three years writing queries, mutations
  ...
  la: {
    ...
    elaboration: `Marketing website for the game "Lost Ark". The site uses a
    framework developed in-house that most of the marketing sites are built upon.
    We used Freemarker Template Language, Sass, and TypeScript. For each site,
    we implemented designs usually made in Figma by various design teams. I worked
  ...
  nw: {
    ...
    elaboration: `Marketing website for the game "New World". The site uses a
    framework developed in-house that most of the marketing sites are built upon.
    We used Freemarker Template Language, Sass, and TypeScript. For each site,
    we implemented designs usually made in Figma by various design teams. I worked
    on multiple pages and modules on each site making sure the pages matched the
  ...
  tl: {
    ...
    elaboration: `Marketing website for the game "Throne & Liberty". The site uses a
    framework developed in-house that most of the marketing sites are built upon.
    We used Freemarker Template Language, Sass, and TypeScript. For each site,
    we implemented designs usually made in Figma by various design teams. I worked
    on multiple pages and modules on each site making sure the pages matched the
